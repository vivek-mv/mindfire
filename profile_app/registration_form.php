<?php
	...
	if( isset($_GET["userId"]) && isset($_GET["userAction"]) ) {
		...
		$selectEmpDetails="SELECT employee.eid , employee.prefix , employee.firstName , employee.middleName , employee.lastName ,employee.gender ,
				...
				AS comm_email, 
				commMedium.call , commMedium.any 
